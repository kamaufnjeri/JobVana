...
const NotificationsContainer = () => {
  ...
  return (
    <div
      className={`transition-all duration-500 ease-out fixed top-20 right-0 p-4 z-50 items-start flex flex-col gap-2 min-h-[200px] bg-gray-600 text-white h-auto ${showNotifications ? "w-full md:w-2/3 lg:w-1/2 opacity-100" : "w-[0px] opacity-0"}  rounded-lg shadow-lg`}
    >
