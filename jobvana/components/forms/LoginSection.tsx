  ...
  return (
   ...
   <LoginForm/>
      ...
      <div className="w-full h-auto rounded-md relative">
        ...
        <p className="text-p readable text-right">“Log in to unlock your next opportunity. Whether you're seeking talent or looking for your dream job, we’re here to connect you with the right people.”</p>
