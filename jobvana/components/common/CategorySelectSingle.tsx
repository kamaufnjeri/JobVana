...
const CategorySelectSingle: React.FC<LocationSelectProps> = ({ selected, setSelected}) => {

    const selectedOptions = JOB_CATEGORIES.filter((loc) =>( selected.includes(loc.value)));
